      ...
      <div className="relative z-10">
        <div className="container">
          ...
          <div className="title-container text-center">
            <h1 className="text-heading font-bold font-heading">
              Division
            </h1>
